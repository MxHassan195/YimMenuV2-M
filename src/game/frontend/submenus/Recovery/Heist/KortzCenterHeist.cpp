...
namespace YimMenu::Submenus
{
  std::shared_ptr<TabItem> RenderKortzCenterHeistMenu()
  {
    ...
    vehiclesGroup->AddItem(std::make_shared<BoolCommandItem>("kortzcenterheistmanchezred"_J));
    vehiclesGroup->AddItem(std::make_shared<BoolCommandItem>("kortzcenterheistmanchezblue"_J));
    vehiclesGroup->AddItem(std::make_shared<BoolCommandItem>("kortzcenterheistmanchezgreen"_J));
    vehiclesGroup->AddItem(std::make_shared<BoolCommandItem>("kortzcenterheistmanchezyellow"_J));
